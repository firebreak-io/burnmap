 ...
 *
 * A `<style>` override forces the body background transparent so the screenshot
 * (taken with omitBackground) leaves the four corners outside the card's rounded
 * border transparent. This is scoped to the shot HTML; the live SPA is untouched.
 */
